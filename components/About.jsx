...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Priyansha Yeole, a passionate web developer and problem
          solver. Currently,I&apos;m pursuing a B.E. degree in Information Technology and Engineering at
          Mumbai University, India, with an expected
          graduation year of 2027. I&apos;m a  developer with experience
          in Java, TailwindCSS, and JavaScript. I specialize in frameworks
          such as React, Node.js, Next.js,  and Three.js. My
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:priyanshayeole@gmail.com"
            target="_blank"
            rel="noreferrer"
