...
//           to_name: "Priyansha Yeole",
//           from_email: DOMPurify.sanitize(form.email),
//           to_email: "priyanshayeole@gmail.com",
...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
       "service_123456",     // Replace with your EmailJS service ID
        "template_3110",       // 🔁 Your EmailJS template ID
        {
          from_name: DOMPurify.sanitize(form.name),
          to_name: "Priyansha Yeole",
          from_email: DOMPurify.sanitize(form.email),
        ...
        "zIAdmrZmBRoWTTSjJ"          // 🔁 Your EmailJS public API key
      )
      .then(
        () => {
          setLoading(false);
